...
from app.core.models import FlightState, Obstacle, Telemetry
...
class DecisionEngine:
    ...
    def evaluate(self, telemetry: Telemetry, obstacle: Obstacle) -> FlightState:
        ...
        if distance <= self.thresholds.obstacle_avoid_cm:
